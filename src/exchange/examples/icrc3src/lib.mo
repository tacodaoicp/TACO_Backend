  ...
  public class ICRC3(stored : ?State, canister : Principal, environment : Environment) {
    ...
    public func get_blocks(args : Service.GetBlocksArgs) : Service.GetBlocksResult {
      ...
      return {
        ...
        archived_blocks = Iter.toArray<MigrationTypes.Current.ArchivedTransactionResponse>(
          Iter.map<(Vec.Vector<TransactionRange>, MigrationTypes.Current.GetTransactionsFn), MigrationTypes.Current.ArchivedTransactionResponse>(
            Map.vals(archives),
            func(x : (Vec.Vector<TransactionRange>, MigrationTypes.Current.GetTransactionsFn)) : MigrationTypes.Current.ArchivedTransactionResponse {
              {
