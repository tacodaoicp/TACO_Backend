...
module {
  ...
  public type Interface = actor {
    ...
    icrc1_fee : query () -> async (Nat8);
    transfer_fee : query ({}) -> async { transfer_fee : { e8s : Nat64 } };
    send_dfx : SendArgs2 -> async Nat64;
    account_balance_dfx : query ({ account : Text }) -> async ({ e8s : Nat64 });
