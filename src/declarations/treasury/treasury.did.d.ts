...
export interface treasury {
   ...
   */
  'admin_refreshNeutriniteFollowSettings' : ActorMethod<[], Result>,
  /**
   ...
   */
  'admin_registerNeutrinite' : ActorMethod<[], Result>,
   ...
   */
  'getNeutriniteFollowSettings' : ActorMethod<[], Array<[Principal, bigint]>>,
  /**
